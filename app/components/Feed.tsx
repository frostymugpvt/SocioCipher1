    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <button 
          ...
          style={{ padding: '1rem', background: 'var(--color-bg-alt)', color: 'var(--color-text)', textAlign: 'left', borderBottom: '1px solid var(--color-border)', cursor: 'pointer' }}
        >
          ← Back to Global Feed
        </button>
        ...
        <article style={{ padding: '1.5rem', borderBottom: '1px solid var(--color-border)', background: 'rgba(20,20,20,0.5)' }}>
          <div style={{ display: 'flex', gap: '1rem' }}>
            <div style={{
              width: '40px', height: '40px', background: 'var(--color-bg-alt)', border: '1px solid var(--color-border)',
        ...
        <div style={{ padding: '1.5rem', background: 'var(--color-bg-surface)', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ display: 'flex', gap: '1rem' }}>
             <textarea
                ...
                style={{ flex: 1, background: 'var(--color-bg)', border: '1px solid var(--color-border)', padding: '1rem', color: 'var(--color-text-primary)', resize: 'none', minHeight: '60px' }}
              />
          </div>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.4rem', alignItems: 'center' }}>
                  <div style={{ display: 'flex', gap: '0.6rem', alignItems: 'center', minWidth: 0 }}>
                    <span style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--color-text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{post.alias}</span>
