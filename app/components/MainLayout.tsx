    ...
    <div className="main-grid">
      ...
      <aside className={`left-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
        <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--color-border)', background: 'var(--color-bg)' }}>
          <div className="mono" style={{ color: 'var(--color-text-muted)', fontSize: '0.6rem', marginBottom: '0.2rem' }}>ASSIGNED_ID</div>
          <div style={{ fontSize: '1.2rem', fontWeight: 'bold', color: 'var(--color-text)' }}>{user?.badgeNumber || 'SC-XXXX-XXXX'}</div>
